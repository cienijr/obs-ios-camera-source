...
if(LIBOBS_FOUND)
	...
	include(${LIBOBS_INCLUDE_DIR}/../cmake/external/ObsPluginHelpers.cmake OPTIONAL)
	include(${LIBOBS_INCLUDE_DIR}/../cmake/ObsPluginHelpers.cmake OPTIONAL)

	# allows external plugins to easily use/share common dependencies that are often included with libobs (such as FFmpeg)
	if(NOT DEFINED INCLUDED_LIBOBS_CMAKE_MODULES)
		set(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} "${LIBOBS_INCLUDE_DIR}/../cmake/Modules/" "${LIBOBS_INCLUDE_DIR}/../cmake/finders/")
